...
def test_provisioner_encodes_isolation_and_safe_secret_handling() -> None:
    ...
    for script_name in ("inspect_workbook.py", "originality_guard.py", "run_task.py", "validate_output.py", "visual_context.py", "write_workbook.py"):
...
def test_excel_scripts_disable_bytecode_before_dynamic_imports() -> None:
    ...
    for name in ("inspect_workbook.py", "originality_guard.py", "run_task.py", "validate_output.py", "visual_context.py", "write_workbook.py"):
