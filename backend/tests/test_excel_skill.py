...
def test_workbook_inspector_uses_the_same_500_mib_upload_cap(excel_modules) -> None:
    inspect, _, _, _ = excel_modules

    assert inspect.MAX_FILE_BYTES == 500 * 1024 * 1024
    assert inspect.MAX_UNCOMPRESSED_BYTES == 1024 * 1024 * 1024
